...
-------Ex.21-------
--SELECT DepartmentID = 'Engineering' , 'Tool Design' , 'Marketing','Information Service'
--FROM Employees
--UPDATE Employees
...
--WHERE Name LIKE 'b%' OR Name LIKE'%e' OR Name LIKE'm%' OR NAME LIKE 'k%'
ORDER BY Name 
------7--------
SELECT TownId,Name
FROM Towns
...
,DENSE_RANK() OVER   
    (PARTITION BY FirstName ORDER BY Salary DESC) AS Rank
FROM Employees
